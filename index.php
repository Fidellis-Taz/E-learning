...
<div class="container-fluid remove-vid-marg">
    <div class="vid-parent">
        <video playsinline autoplay muted loop >
            <source src="video/bak.mp4">
        </video>
        <div class="vid-overlay"></div>
    </div>
    <div class="vid-content">
        <h1 class="my-content">Welcome To eLearn</h1>
        <small class="my-content">Learn and İmplement</small>
...
<div class="col-sm">
    <h5><i class="fas fa-users mr-3"> </i>Expert İnstructors</h5>
</div>
<div class="col-sm">
...
<div class="card">
    ...
    <div class="card-footer">
        <p class="card-text d-line">Price: <small><del>&#8377 3000</del></small><span class="font-weight-bolder">&#8377 300</span></p>
        <a class="btn btn-primary text-white font-white font-weight-bolder float-right" href="coursedetails.php">Enroll</a>
    </div>
</div>
</a>
</div>
